"""
    ...
    Version 2 Abhinav Kumar 2019-03-11 (classifier size input dimension is now automatic)
...
from train.lenet import LeNet, LeNetMask 
...
def lenetPrune(input_dim=32, class_num=10):
    return LeNetMask(input_dim)
